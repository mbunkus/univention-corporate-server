...
#  admin module for the Primary Directory Node hosts
#
...
docleanup = 1
childs = 0
short_description = _('Computer: Primary Directory Node')
object_name = _('Primary Directory Node')
object_name_plural = _('Primary Directory Nodes')
long_description = ''
options = {
